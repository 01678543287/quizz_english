...
const STORAGE_KEY = 'quiz_exam_answers_duoclieu_v1';
...
const examIndexesKey = 'quiz_exam_indexes_duoclieu_v1';
const shuffledOptionsKey = 'quiz_exam_shuffled_options_duoclieu_v1';

function getExamIndexes() {
    try {
        const stored = localStorage.getItem(examIndexesKey);
        if (stored) {
